...
El contenido de este capítulo ya se ha visto en la asignatura [Inferencia Estadística 1](https://guies.uab.cat/guies_docents/public/portal/html/2020/assignatura/104855/es), pero aquí pretendemos extender muchos de los conceptos aprendidos, así como introducir nuevas metodologías relacionadas con la regresión lineal. 
...
![Regresión lineal simple](fig/reg_lin.png)
...
En general, podemos usar `optim()` para buscar el máximo de cualquier otro dataset 
...
Esta metodología podría ser utilizada para encontrar $\alpha$ y $\beta$ escribiendo de forma adecuada la función que se le pasa a `optim()` en el argumento 'fn' [EJERCICIO]. Sin embargo, R tiene incorporado una función para obtener los estimadores máximos verosímiles utilizando algoritmos más eficientes basados en la estimación por mínimos cuadrados vista en secciones anteriores  y que están implementados en la función `lm()`.  
