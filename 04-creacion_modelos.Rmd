...
![Selección hacia atrás](figures/fwd_stepwise.png){width=40%}
...
La selección hacia adelante se estableció en 19 predictores con un $R^2$ de .55.
...
La selección hacia detrás se estableció en 10 predictores con un $R^2$ de .54. Con muchas menos variables, somos capaces de explicar prácticamente la misma variabilidad.
...
- Si los nuevos datos están completos, podemos utilizar las estimaciones de coeficientes derivadas de la imputación múltiple en una ecuación de regresión para la predicción. Pero esto es difícil. Usamos los datos originales de Carseats como ilustración.
