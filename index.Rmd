...
Algunas partes de este material está inspirados en vignettes que se referencian en cada capítulo y en algunos de los trabajos de [Jeff Webb](https://github.com/jefftwebb) y [Freddy Hernández](https://github.com/fhernanb). Este material está licenciado bajo una [Creative Commons Attribution 4.0 International License](https://creativecommons.org/licenses/by/4.0/).
